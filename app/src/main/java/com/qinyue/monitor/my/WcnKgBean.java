 ...
 * 描述:
 **/
public class WcnKgBean implements Serializable {

    /**
     * plaintiffSex : 男
     * caseOrgName : null
     * plaintiffDuty : null
     * juvenileBirthday : 2016-04-03T16:00:00Z
     ...
     * caseNature : null
     * defendantDomicile : 河北省唐山市路南区
     * feedback : null
     * defendantOtherIdentity : 中介机构
     * lastUpdated : 2020-04-02T19:07:26Z
     * score : null
     * juvenileResidenceid : null
     * defendantAddress : 肯定就是
     * id : 13
     * isRepeat : null
     * reply : null
     * isTrans : null
     * juvenileAgent : 大姐姐都觉得
     * defendantUnit : 么么么
     * decReason : null
     * replyDate : null
     * plaintiffNation : 汉族
     * juvenileAge : 已满12周岁不满14周岁
     * caseOrgSrcName : null
     * caseOrgType : null
     * defendantName : 么事么事
     * accuseOtherReason : 拐卖妇女、儿童罪
     * plaintiffResidence : 见到你等你
     * juvenileResidence : 辽宁省沈阳市沈河区
     * status : 待办理
     * imgList : []
     ...
     * plaintiffIdentity : 工人
     * juvenileCertificateType : 居民身份证
     * plaintiffCertificateNumber : 140108199807124214
     * defendantDuty : 没什么
     * salveeType : null
     * juvenileNameBefore : 那等你
     * juvenileSchoolAddressid : null
     * juvenileSchool : 就是八点半
     * juvenileGuardState : 祖父或外祖父监护
     * content : 大姐大姐
     * caseType : null
     * defendantIdentity : 工人
     * plaintiffName : 谢立秋
     * caseRemark : null
     * dateCreated : 2020-04-02T19:07:26Z
     * juvenilePosition : null
     * appealType : null
     ...
     * juvenileSchoolAddress : 内蒙古自治区呼和浩特市新城区
     * defendantSex : 男
