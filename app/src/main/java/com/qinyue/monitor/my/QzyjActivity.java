 ...
 * 描述:
 **/
public class QzyjActivity extends BaseActivity {
    ...
    protected void initview() {
        ...
        commonAdapter = new CommonAdapter<QzyjBean>(this,R.layout.item_qzyj,qzyjBeans) {
            @Override
            protected void convert(ViewHolder holder, QzyjBean qzyjBean, int pos) {
                pos++;
                holder.setText(R.id.item_num, pos+"");
                holder.setText(R.id.item_type, qzyjBean.getType());
                holder.setText(R.id.item_title, qzyjBean.getTitle());
                holder.setText(R.id.item_time, qzyjBean.getDateCreated());
                holder.setText(R.id.item_state, qzyjBean.getStatus());
            }
        };
        ...
        commonAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                Intent intent  =new Intent(QzyjActivity.this,QzyjDetailsActivity.class);
