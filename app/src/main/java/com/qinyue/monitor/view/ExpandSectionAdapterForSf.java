 ...
 * 描述:
 **/
public class ExpandSectionAdapterForSf extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private ChooseSfActivity context;
    private List<SelectSectionParentEntity> dataBeanList = new ArrayList<>();
    private LayoutInflater mInflater;
    private OnScrollListener mOnScrollListener;

    public ExpandSectionAdapterForSf(ChooseSfActivity context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case SelectSectionParentEntity.CHILD_ITEM:
                ...
                return new ChildViewHolderForSf(context, view);
            default:
                view = mInflater.inflate(R.layout.item_parent, parent, false);
                return new ParentViewHolder(context, view);
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)){
            case SelectSectionParentEntity.PARENT_ITEM:
                ...
                break;
            case SelectSectionParentEntity.CHILD_ITEM:
                ChildViewHolderForSf childViewHolder = (ChildViewHolderForSf) holder;
