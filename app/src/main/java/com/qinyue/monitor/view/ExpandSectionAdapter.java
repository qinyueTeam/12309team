 ...
 * 描述:
 **/
public class ExpandSectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private ChooseAfdActivity context;
    private List<SelectSectionParentEntity> dataBeanList = new ArrayList<>();
    private LayoutInflater mInflater;
    private OnScrollListener mOnScrollListener;

    public ExpandSectionAdapter(ChooseAfdActivity context) {
