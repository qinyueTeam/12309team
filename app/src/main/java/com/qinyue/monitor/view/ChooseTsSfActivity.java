 ...
 * 描述:
 **/
public class ChooseTsSfActivity extends BaseActivity {
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    ExpandSectionAdapterForTsSf expandSectionAdapter;
    private int index = 0;
    List<SfBean> sfBeans;
    @Override
    ...
    protected void initview() {
        sfBeans = JsonUtils.getInstance().gson.fromJson(getString(R.string.str_tssf),new TypeToken<List<SfBean>>(){}.getType());
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        DividerItemDecoration divider = new DividerItemDecoration(this, DividerItemDecoration.VERTICAL);
        divider.setDrawable(ContextCompat.getDrawable(this, R.drawable.shape_grey_divider));
        recyclerView.addItemDecoration(divider);
        expandSectionAdapter = new ExpandSectionAdapterForTsSf(this);
