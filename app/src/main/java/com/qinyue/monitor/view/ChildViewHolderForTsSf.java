 ...
 * 描述:
 **/
public class ChildViewHolderForTsSf extends RecyclerView.ViewHolder {
    private LinearLayout containerLayout;
    private ChooseTsSfActivity mContext;
    private View view;
    private TextView childLeftText;

    public ChildViewHolderForTsSf(ChooseTsSfActivity context, View itemView) {
        super(itemView);
