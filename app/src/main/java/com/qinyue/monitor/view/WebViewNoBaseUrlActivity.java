 ...
 * 描述:
 **/
public class WebViewNoBaseUrlActivity extends BaseActivity {
...
//        webview.loadData(varjs+data,"text/html", "UTF-8");
        webview.loadDataWithBaseURL(TagConstant.BASEURL2,data, "text/html", "utf-8",null);
    ...
    public class JavascriptInterface {
        ...
        public void startPhotoActivity(String imageUrl) {
            ...
            //根据URL查看大图逻辑
            PictureSelector.create(WebViewNoBaseUrlActivity.this)
