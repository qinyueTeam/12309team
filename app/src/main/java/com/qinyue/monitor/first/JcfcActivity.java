 ...
 * 描述:
 **/
public class JcfcActivity extends BaseActivity {
    ...
    protected void initview() {
        ...
        commonAdapter = new CommonAdapter<JcxwdtListBean>(JcfcActivity.this, R.layout.item_jcxwdt, jwxzBeans) {
            @Override
            protected void convert(ViewHolder holder, JcxwdtListBean messageBean, int pos) {
                ...
                if (messageBean.getImage()!=null&&!messageBean.getImage().isEmpty()){
                    ...
                    Glide.with(JcfcActivity.this).load(messageBean.getImage()).fitCenter().into(imageView);
                }else {
        ...
        commonAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder viewHolder, int i) {
                Intent intent = new Intent(JcfcActivity.this, WebViewActivity.class);
