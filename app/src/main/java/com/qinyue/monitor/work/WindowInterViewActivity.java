...
public class WindowInterViewActivity extends BaseActivity {
        ...
        Disposable subscribe = RxHttp.postForm(TagConstant.BASEURL + NetConstant.getTypeCode)
                ...
                .subscribe(s -> {
                    ...
                    if ("200".equals(s.getResult())) {
                        ...
                        XToast.error(WindowInterViewActivity.this, s.getMsg()).show();
                    }
                }, throwable -> {
                    miniLoadingDialog.dismiss();
                    XToast.error(WindowInterViewActivity.this, throwable.getMessage()).show();
                });
    }
...
//        String a = JsonUtils.getInstance().gson.toJson(map);
        Disposable subscribe = RxHttp.postForm(TagConstant.BASEURL + NetConstant.YYSPJF)
                ...
                .subscribe(s -> {
                    miniLoadingDialog.dismiss();
                    if (s.getResult()==200){
                        XToast.success(WindowInterViewActivity.this,s.getMessage()).show();
                        finish();
                    }else {
                        XToast.error(WindowInterViewActivity.this,s.getMessage()).show();
                    }
                }, throwable -> {
                    miniLoadingDialog.dismiss();
                    XToast.error(WindowInterViewActivity.this,throwable.getMessage()).show();
