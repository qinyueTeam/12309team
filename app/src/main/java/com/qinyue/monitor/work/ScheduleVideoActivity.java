...
//        String a = JsonUtils.getInstance().gson.toJson(map);
        Disposable subscribe = RxHttp.postForm(TagConstant.BASEURL + NetConstant.YYSPJF)
                ...
                .subscribe(s -> {
                    ...
                    if (s.getResult()==200){
                        XToast.success(ScheduleVideoActivity.this,s.getMessage()).show();
                        finish();
                    }else {
                        XToast.error(ScheduleVideoActivity.this,s.getMessage()).show();
                    }
                }, throwable -> {
                    miniLoadingDialog.dismiss();
                    XToast.error(ScheduleVideoActivity.this,throwable.getMessage()).show();
                });
    }
        ...
        Disposable subscribe = RxHttp.postForm(TagConstant.BASEURL + NetConstant.getTypeCode)
                ...
                .subscribe(s -> {
                    ...
                    if ("200".equals(s.getResult())) {
                        ...
                        XToast.error(ScheduleVideoActivity.this, s.getMsg()).show();
                    }
                }, throwable -> {
                    miniLoadingDialog.dismiss();
                    XToast.error(ScheduleVideoActivity.this, throwable.getMessage()).show();
